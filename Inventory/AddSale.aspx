<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMaster.Master" AutoEventWireup="true" CodeBehind="AddSale.aspx.cs" Inherits="Inventory.AddSale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <asp:LinkButton runat="server" href="SaleList.aspx" CssClass="btn btn-info" Style="position: absolute; right: 125px; top: 100px;">Sale List</asp:LinkButton>
        ...
        <div class="card mb-4">
            <h6 class="card-header">Sale Item</h6>
            <div class="card-body">
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <asp:TextBox ID="txtSalePrice" runat="server" CssClass="form-control" onKeyUp="calculate()"></asp:TextBox>
                        <div class="clearfix"></div>
                    </div>
                    <div class="form-group col-md-2">
                        <label class="form-label">Quantity</label>
                        <asp:TextBox ID="txtQty" runat="server" CssClass="form-control" onKeyUp="calculate()"></asp:TextBox>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <asp:TextBox ID="txtGstPercent" runat="server" CssClass="form-control" onKeyUp="calculate()"></asp:TextBox>
                        <div class="clearfix"></div>
                    </div>
                    <div class="form-group col-md-2">
                ...
                <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary float-right" Text="Submit" OnClick="btnSubmit_Click"></asp:Button>
            </div>
        </div>
    ...
    <script type="text/javascript">
        function calculate() {
            ...
            var purchase_price = document.getElementById('<%=txtSalePrice.ClientID%>').value;
        ...
        function AddRow() {
            ...
            var purchaseprice = document.getElementById('<%=txtSalePrice.ClientID%>').value;
            var qty = document.getElementById('<%=txtQty.ClientID%>').value;
            var gst = document.getElementById('<%=txtGstPercent.ClientID%>').value;
            ...
            if (itemvalue && purchaseprice && qty && purchaseprice >= 0 && qty >= 0) {
                ...
                var txt_gst = document.getElementById('<%=txtGstPercent.ClientID%>').value;
                var purchasePrice = document.getElementById('<%=txtSalePrice.ClientID%>').value;
                var itemQuantity = document.getElementById('<%=txtQty.ClientID%>').value;
                ...
                document.getElementById('<%=txtGstPercent.ClientID%>').value = "";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.map(data.d, function (item) {
                        ...
                        document.getElementById('<%=txtGstPercent.ClientID%>').value = parseInt(item.GSTPercent);
                        document.getElementById('<%=txtSalePrice.ClientID%>').value = parseInt(item.Price);
                    });
